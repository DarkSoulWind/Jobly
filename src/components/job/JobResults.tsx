...
import LoadingJobListing from "src/components/job/SkeletonLoadingJob";
import { JobListing } from "src/lib/scraper";
import {
...
const JobListingComponent = lazy(() =>
	import("src/components/job/JobListing").then((module) => ({
