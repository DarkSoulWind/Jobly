...
const Comment: FC<CommentProps> = ({ commentData, isAuthor, yourData }) => {
      ...
      <div className="w-full bg-slate-200 p-2 rounded-lg text-sm">
        ...
        <h3 className="font-bold">
          <a
            ...
            onClick={() => router.push(`/user/${commentData.user.name}`)}
          >
            {commentData.user.preferences?.firstName ?? commentData.user.name}{" "}
        ...
        {confirmDeleteOpen && (
          ...
          >
            <p className="font-bold">
              This will permanently delete your comment forever.
            </p>
          </Modal>
        )}
      </AnimatePresence>
